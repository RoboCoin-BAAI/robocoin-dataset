...
class EpisodeFramesCollectorVisionPro(EpisodeFramesCollector):
        ...
        for hdf5_file in hdf5_files:
            ...
            try:
                with h5py.File(hdf5_file, "r") as f:
                    episode_frames_num = f["head_pose"].shape[0]
                    self.episode_frames_num.append(episode_frames_num)
            except Exception:
                continue

        return self.episode_frames_num
